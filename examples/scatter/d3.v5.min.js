...
!(function (t, n) {
    ...
    function zn(t) {
        ...
        return (
            r === i && i === o
                ? (n = e = a)
                : ((n = qn(
                      (0.4360747 * r + 0.3850649 * i + 0.1430804 * o) / An
                  )),
                  (e = qn(
                      (0.0139322 * r + 0.0971045 * i + 0.7141733 * o) / Sn
                  ))),
    ...
    function mr(t, n, e, r, i, o) {
        ...
        !(function (t, n, e) {
            ...
            function u() {
                for (var r in ((e.state = br), e.timer.stop(), delete i[n], i))
                    return;
    ...
    function zi(n) {
        ...
        return (
            ...
            (s.prototype = {
                ...
                emit: function (t) {
                    St(
                        new hi(u, t, n.output(this.state.selection)),
                        o.apply,
                        o,
    ...
    function Co(t) {
        ...
        function r(t, n) {
            ...
            for (
                t.charCodeAt(o - 1) === No && --o,
                    t.charCodeAt(o - 1) === Ao && --o;
                (r = s()) !== wo;
    ...
    (sa.copy = function () {
        ...
        (sa.visitAfter = function (t) {
            ...
            for (
                this._root &&
                e.push(
                    new ia(this._root, this._x0, this._y0, this._x1, this._y1)
                );
                (n = e.pop());
    ...
    var Ta = {
        ...
        s: function (t, n) {
            ...
            var r = e[0],
                ...
                o =
                    i -
                    (xa = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) +
                    1,
                a = r.length;
            return o === a
                ? r
        ...
        function c(t) {
            ...
            function m(t) {
                ...
                switch (
                    (h &&
                        s &&
                        ((t = r(N + t, N.length ? l - x.length : 1 / 0)),
                        (N = "")),
                    e)
                ) {
                    case "<":
    ...
    function Ra(t, n) {
        return Math.max(
            0,
            3 * Math.max(-8, Math.min(8, Math.floor(ma(n) / 3))) -
                ma(Math.abs(t))
        );
    }
    function Da(t, n) {
    ...
    var Tf,
        ...
        zf = {
            ...
            polygonEnd: function () {
                (zf.lineStart = zf.lineEnd = zf.point = cu),
                    Cf.add(Va(Pf)),
                    Pf.reset();
            },
            result: function () {
    ...
    function ih(t) {
        for (var n, e, r, i = t.length, o = [0, 1], a = 2, u = 2; u < i; ++u) {
            for (
                ...
                (e = t[o[a - 1]]),
                (r = t[u]),
                (e[0] - n[0]) * (r[1] - n[1]) - (e[1] - n[1]) * (r[0] - n[0]) <=
                    0);
    ...
    function kh() {
        ...
        function s() {
            return (
                (r = Math.min(a.length, u.length) > 2 ? Th : Ah),
                (i = o = null),
                l
            );
        }
        ...
        ud = Zh(
            ...
            function (t, n) {
                return (
                    (n -
                        t -
                        (n.getTimezoneOffset() - t.getTimezoneOffset()) * Kh) /
                    864e5
                );
            },
            function (t) {
            ...
            point: function (t, n) {
                ...
                if (((n = +n), (t = +t) !== this._x1 || n !== this._y1)) {
                    switch (this._point) {
                        ...
                        case 2:
                            (this._point = 3),
                                C_(this, E_(this, (e = k_(this, t, n))), e);
                            break;
                        default:
    ...
    function Tb(t, n) {
        var e,
            ...
            o = t.sort(Ab).pop();
        for (
            wb = [], mb = new Array(t.length), bb = new V_(), xb = new V_();
            ;
    ...
    (Pb.prototype = Eb.prototype),
                    ...
                    for (u = 0, i = new Array(f); u < s; ++u)
                        ((c = t[u]).index = u),
                            "object" != typeof c.source &&
                                (c.source = pa(l, c.source)),
                            "object" != typeof c.target &&
                                (c.target = pa(l, c.target)),
        ...
        (t.geoCentroid = function (t) {
            (Hu = Xu = Gu = Vu = $u = Wu = Zu = Qu = Ju = Ku = tc = 0),
                pu(t, _c);
            var n = Ju,
                e = Ku,
                r = tc,
        ...
        (t.geoCircle = function () {
            ...
            return (
                (a.center = function (t) {
                    return arguments.length
                        ? ((e =
                              "function" == typeof t ? t : Ec([+t[0], +t[1]])),
                          a)
                        : e;
                }),
                (a.radius = function (t) {
        ...
        (t.tree = function () {
            ...
            function i(i) {
                var c = (function (t) {
                    for (
                        var n, e, r, i, o, a = new Ql(t, 0), u = [a];
                        (n = u.pop());
                        ...
                        if ((r = n._.children))
                            for (
                                ...
                                u.push((e = n.children[i] = new Ql(r[i], i))),
                                    (e.parent = n);
        ...
        (t.pie = function () {
            ...
            function a(a) {
                var u,
                    ...
                    y = Math.min(
                        hy,
                        Math.max(-hy, i.apply(this, arguments) - g)
                    ),
